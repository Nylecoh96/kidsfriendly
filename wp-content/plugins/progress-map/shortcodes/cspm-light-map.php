							...
							onces: {
								tilesloaded: function(){
									...
									if($this->plugin_settings['zoomControl'] == 'true' && $this->plugin_settings['zoomControlType'] == 'customize'){ ?>
										...
										$('div.cspm_zoom_in_<?php echo $map_id ?>, div.cspm_zoom_out_<?php echo $map_id ?>').show(); <?php 
						...
						google.maps.event.addListener(streetView, "visible_changed", function(){
							...
							if(this.getVisible()){
								...
								<?php if($this->plugin_settings['zoomControl'] == 'true' && $this->plugin_settings['zoomControlType'] == 'customize'){ ?>
									$('div.cspm_zoom_in_<?php echo $map_id; ?>, div.cspm_zoom_out_<?php echo $map_id; ?>').hide();
								<?php } ?>
								...
								<?php if($this->plugin_settings['zoomControl'] == 'true' && $this->plugin_settings['zoomControlType'] == 'customize'){ ?>
									$('div.cspm_zoom_in_<?php echo $map_id; ?>, div.cspm_zoom_out_<?php echo $map_id; ?>').show();
								<?php } ?>
